...
case class ViewStudentLoansDeductionsAudit(taxYear: Int,
                                           userType: String,
                                           nino: String,
                                           mtditid: String,
                                           deductions: Option[Deductions]) {

  private val name: String = "ViewStudentLoansDeductions"

  def toAuditModel: AuditModel[ViewStudentLoansDeductionsAudit] = AuditModel(name, name, this)
}

object ViewStudentLoansDeductionsAudit {
  implicit def writes: Writes[ViewStudentLoansDeductionsAudit] = (audit: ViewStudentLoansDeductionsAudit) => {
    Json.obj(
