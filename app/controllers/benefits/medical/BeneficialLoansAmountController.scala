...
class BeneficialLoansAmountController @Inject()(implicit val cc: MessagesControllerComponents,
  ...
  private def redirects(cya: EmploymentCYAModel, taxYear: Int, employmentId: String) = {
    RedirectService.beneficialLoansAmountRedirects(cya, taxYear, employmentId)
  }
      ...
      employmentSessionService.getAndHandle(taxYear, employmentId) { (optCya, prior) =>
        ...
        redirectBasedOnCurrentAnswers(taxYear, employmentId, optCya, EmploymentBenefitsType)(redirects(_, taxYear, employmentId)) { cya =>
          ...
          val form = fillFormFromPriorAndCYA(amountForm, prior, cyaAmount, employmentId)(
            employment =>
              employment.employmentBenefits.flatMap(_.benefits.flatMap(_.beneficialLoan))
          )
              ...
              amount =>
                ...
                val updatedCyaModel = cyaModel.copy(
                  employmentBenefits = benefits.map(_.copy(medicalChildcareEducationModel =
                    medicalChildcareEducationModel.map(_.copy(beneficialLoan = Some(amount)))))
                )
                ...
                employmentSessionService.createOrUpdateSessionData(employmentId, updatedCyaModel, taxYear,
                  ...
                  if (cya.isPriorSubmission) {
                    ...
                    //TODO - redirect to the first page of the income tax and costs benefits section
                    Redirect(CheckYourBenefitsController.show(taxYear, employmentId))
                  }
                }
            }
