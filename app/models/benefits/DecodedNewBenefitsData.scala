...
case class DecodedNewBenefitsData(accommodation: Option[BigDecimal] = None,
...
object DecodedNewBenefitsData {
  ...
  implicit val format: OFormat[DecodedNewBenefitsData] = {
