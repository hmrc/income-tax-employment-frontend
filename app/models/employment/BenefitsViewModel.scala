...
object BenefitsViewModel {
  ...
  val firstSetOfFields: OFormat[(Option[AccommodationRelocationModel], Option[CarVanFuelModel], Option[BigDecimal], Option[BigDecimal], Option[BigDecimal],
  ...
  implicit val format: OFormat[BenefitsViewModel] = {
    (firstSetOfFields and secondSetOfFields and thirdSetOfFields and fourthSetOfFields).apply({
      case (
        (accommodationRelocationModel, carVanFuelModel, assets, assetTransfer, beneficialLoan, educationalServices, entertaining,
        ...
        BenefitsViewModel(
          accommodationRelocationModel, carVanFuelModel, assets, assetTransfer, beneficialLoan, educationalServices, entertaining, expenses,
      ...
      benefits =>
        (
          (benefits.accommodationRelocationModel, benefits.carVanFuelModel, benefits.assets, benefits.assetTransfer, benefits.beneficialLoan,
...
object EncryptedBenefitsViewModel {
  ...
  val firstSetOfFields: OFormat[(Option[EncryptedAccommodationRelocationModel], Option[EncryptedCarVanFuelModel],
