...
case class BenefitsViewModel(
  ...
  def toBenefits: Benefits ={
    Benefits(
      ...
      paymentsOnEmployeesBehalf, travelEntertainmentModel.flatMap(_.personalIncidentalExpenses), accommodationRelocationModel.flatMap(_.qualifyingRelocationExpenses),
      employerProvidedProfessionalSubscriptions, employerProvidedServices, incomeTaxPaidByDirector, travelEntertainmentModel.flatMap(_.travelAndSubsistence), vouchersAndCreditCards, nonCash
    )
  }
...
object BenefitsViewModel {
  ...
  val firstSetOfFields: OFormat[(Option[CarVanFuelModel], Option[AccommodationRelocationModel], Option[TravelEntertainmentModel],
    ...
    Option[BigDecimal], Option[BigDecimal], Option[BigDecimal], Option[BigDecimal], Option[BigDecimal])] = (
      ...
      (__ \ "travelEntertainment").formatNullable[TravelEntertainmentModel] and
  ...
  implicit val format: OFormat[BenefitsViewModel] = {
    (firstSetOfFields and secondSetOfFields and thirdSetOfFields and fourthSetOfFields).apply({
      case (
        (carVanFuelModel, accommodationRelocationModel, travelEntertainmentModel, assets, assetTransfer, beneficialLoan, educationalServices,
        expenses, medicalInsurance, telephone, service, taxableExpenses,
        nurseryPlaces, otherItems, paymentsOnEmployeesBehalf),
        (employerProvidedProfessionalSubscriptions, employerProvidedServices, incomeTaxPaidByDirector,
        ...
        (employerProvidedProfessionalSubscriptionsQuestion, employerProvidedServicesQuestion, incomeTaxPaidByDirectorQuestion,
        vouchersAndCreditCardsQuestion, nonCashQuestion, submittedOn, isUsingCustomerData, isBenefitsReceived)
        ) =>
        BenefitsViewModel(
          carVanFuelModel, accommodationRelocationModel, travelEntertainmentModel, assets, assetTransfer, beneficialLoan, educationalServices, expenses,
      ...
      benefits =>
        (
          (benefits.carVanFuelModel, benefits.accommodationRelocationModel, benefits.travelEntertainmentModel, benefits.assets,
            benefits.assetTransfer, benefits.beneficialLoan, benefits.educationalServices, benefits.expenses, benefits.medicalInsurance, benefits.telephone,
...
object EncryptedBenefitsViewModel {
  ...
  val firstSetOfFields: OFormat[(Option[EncryptedCarVanFuelModel], Option[EncryptedAccommodationRelocationModel],
    Option[EncryptedTravelEntertainmentModel], Option[EncryptedValue], Option[EncryptedValue],
    ...
    Option[EncryptedValue], Option[EncryptedValue], Option[EncryptedValue], Option[EncryptedValue], Option[EncryptedValue]
      ...
      (__ \ "travelEntertainment").formatNullable[EncryptedTravelEntertainmentModel] and
  ...
  val fourthSetOfFields: OFormat[(Option[EncryptedValue], Option[EncryptedValue], Option[EncryptedValue],
  ...
  implicit val format: OFormat[EncryptedBenefitsViewModel] = {
    (firstSetOfFields and secondSetOfFields and thirdSetOfFields and fourthSetOfFields).apply({
      ...
      benefits =>
        (
          (benefits.carVanFuelModel, benefits.accommodationRelocationModel, benefits.travelEntertainmentModel, benefits.assets, benefits.assetTransfer,
            benefits.beneficialLoan, benefits.educationalServices, benefits.expenses, benefits.medicalInsurance, benefits.telephone,
