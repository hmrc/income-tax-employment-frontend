...
import models.benefits.{EncryptedMedicalChildcareEducationModel, EncryptedUtilitiesAndServicesModel, MedicalChildcareEducationModel, UtilitiesAndServicesModel}
...
case class BenefitsViewModel(
  ...
  def toBenefits: Benefits = {
    Benefits(
      ...
      medicalChildcareEducationModel.flatMap(_.nurseryPlaces), otherItems, paymentsOnEmployeesBehalf,
      ...
      incomeTaxPaidByDirector, travelEntertainmentModel.flatMap(_.travelAndSubsistence), vouchersAndCreditCards, nonCash
    )
  }
  ...
  val incomeTaxDetailsPopulated: Boolean =
    incomeTaxPaidByDirector.isDefined ||
      paymentsOnEmployeesBehalf.isDefined
...
object BenefitsViewModel {
  ...
  val firstSetOfFields: OFormat[(Option[CarVanFuelModel], Option[AccommodationRelocationModel], Option[TravelEntertainmentModel],
    Option[UtilitiesAndServicesModel], Option[MedicalChildcareEducationModel],
    Option[BigDecimal], Option[BigDecimal], Option[BigDecimal], Option[BigDecimal], Option[BigDecimal], Option[BigDecimal])] = (
  ...
  val thirdSetOfFields: OFormat[(Option[Boolean], Option[Boolean], Option[Boolean], Option[Boolean], Option[Boolean], Option[Boolean])] = (
  ...
  val fourthSetOfFields: OFormat[(Option[Boolean], Option[Boolean], Option[Boolean], Option[String], Boolean, Boolean)] = (
  ...
  implicit val format: OFormat[BenefitsViewModel] = {
    (firstSetOfFields and secondSetOfFields and thirdSetOfFields and fourthSetOfFields).apply({
      case (
        ...
        assets, assetTransfer, expenses, taxableExpenses, otherItems, paymentsOnEmployeesBehalf),
        (incomeTaxPaidByDirector, vouchersAndCreditCards, nonCash),
        (assetsQuestion, assetTransferQuestion, expensesQuestion, taxableExpensesQuestion, otherItemsQuestion, paymentsOnEmployeesBehalfQuestion),
        (incomeTaxPaidByDirectorQuestion, vouchersAndCreditCardsQuestion, nonCashQuestion, submittedOn, isUsingCustomerData, isBenefitsReceived)
        ) =>
        BenefitsViewModel(
          carVanFuelModel, accommodationRelocationModel, travelEntertainmentModel, utilitiesAndServicesModel, medicalChildcareEducationModel,
          assets, assetTransfer, expenses, taxableExpenses, otherItems, paymentsOnEmployeesBehalf, incomeTaxPaidByDirector, vouchersAndCreditCards, nonCash,
          assetsQuestion, assetTransferQuestion, expensesQuestion, taxableExpensesQuestion, otherItemsQuestion, paymentsOnEmployeesBehalfQuestion,
          incomeTaxPaidByDirectorQuestion, vouchersAndCreditCardsQuestion, nonCashQuestion, submittedOn, isUsingCustomerData, isBenefitsReceived
        )
    }, {
      benefits =>
        (
          (benefits.carVanFuelModel, benefits.accommodationRelocationModel, benefits.travelEntertainmentModel, benefits.utilitiesAndServicesModel,
            benefits.medicalChildcareEducationModel, benefits.assets, benefits.assetTransfer, benefits.expenses, benefits.taxableExpenses,
            benefits.otherItems, benefits.paymentsOnEmployeesBehalf),
          (benefits.incomeTaxPaidByDirector, benefits.vouchersAndCreditCards, benefits.nonCash),
          ...
          (benefits.incomeTaxPaidByDirectorQuestion, benefits.vouchersAndCreditCardsQuestion, benefits.nonCashQuestion,
...
object EncryptedBenefitsViewModel {
  ...
  val fourthSetOfFields: OFormat[(Option[EncryptedValue], Option[EncryptedValue], Option[EncryptedValue], Option[EncryptedValue], EncryptedValue,
    EncryptedValue)] = (
      ...
      benefits =>
        (
          ...
          (benefits.assetsQuestion, benefits.assetTransferQuestion, benefits.expensesQuestion, benefits.taxableExpensesQuestion, benefits.otherItemsQuestion,
            benefits.paymentsOnEmployeesBehalfQuestion),
          (benefits.incomeTaxPaidByDirectorQuestion, benefits.vouchersAndCreditCardsQuestion, benefits.nonCashQuestion, benefits.submittedOn,
