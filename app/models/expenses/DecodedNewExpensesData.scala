...
case class DecodedNewExpensesData(businessTravelCosts: Option[BigDecimal] = None,
...
object DecodedNewExpensesData {
  implicit val format: OFormat[DecodedNewExpensesData] = Json.format[DecodedNewExpensesData]
}
