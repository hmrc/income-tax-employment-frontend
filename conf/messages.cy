...
expense.caption = Employment expenses for 6 April {0} to 5 April {1}
...
expenses.uniformsWorkClothesTools.checkIfYouCanClaimLink.individual = Check if you can claim flat rate expenses for uniforms, work clothes, or tools (opens in new tab).
expenses.uniformsWorkClothesTools.checkIfYouCanClaimLink.agent = Check if your client can claim flat rate expenses for uniforms, work clothes, or tools (opens in new tab).
