...
benefits.employerProvidedServices.paragraph.individual = These are services you used that are not related to your job. Your employer pays for them.
benefits.employerProvidedServices.paragraph.agent = These are services they used that are not related to their job. Their employer pays for them.
benefits.employerProvidedServices.forExample = For example, subscriptions or laundry services.
