...
class CheckEmploymentDetailsControllerISpec extends IntegrationTest with ViewHelpers with EmploymentDatabaseHelper {
  ...
  object CommonExpectedEN extends CommonExpectedResults {
    ...
    val continueButtonLink = "/update-and-submit-income-tax-return/employment-income/2021/check-employment-details?employmentId=" + employmentId
    val taxButtonLink = "/update-and-submit-income-tax-return/employment-income/2021/uk-tax?employmentId=" + employmentId
