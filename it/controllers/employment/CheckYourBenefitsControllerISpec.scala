    ...
    userScenarios.foreach { user =>
      s"language is ${welshTest(user.isWelsh)} and request is from an ${agentTest(user.isAgent)}" should {
        ...
        "return only the relevant data on the page when only certain data items are in mongodb and in year" which {
          ...
          textOnPageCheck("Yes", fieldAmountSelector(7, 1), "for vehicles section question")
          textOnPageCheck(common.companyCar, fieldNameSelector(7, 2))
          textOnPageCheck("No", fieldAmountSelector(7, 2), "for carQuestion")
          textOnPageCheck(common.fuelForCompanyCar, fieldNameSelector(7, 3))
          textOnPageCheck("No", fieldAmountSelector(7, 3), "for carFuelQuestion")
          textOnPageCheck(common.companyVan, fieldNameSelector(7, 4))
          textOnPageCheck("Yes", fieldAmountSelector(7, 4), "for vanQuestion")
          ...
          textOnPageCheck("Yes", fieldAmountSelector(7, 6), "for vanFuelQuestion")
