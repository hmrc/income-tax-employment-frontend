...
import controllers.employment.EmploymentSummaryControllerISpec.{taxYear, _}
...
class EmploymentSummaryControllerISpec extends IntegrationTest with ViewHelpers {
  ...
  val url =
    s"http://localhost:$port/income-through-software/return/employment-income/$taxYear/employment-summary"
  ...
  "as an individual in english" when {
    ...
    ".show" should {
      ...
      "return single employment summary view when there is only one employment without Expenses and Benefits" which {
        ...
        textOnPageCheck(ContentEN.contentExpectedIndividual, employmentSummaryParagraphSelector)
      ...
      "render multiple employment summary view when there are two employments without Expenses and Benefits" which {
        ...
        titleCheck(ContentEN.titleAndH1Expected)
        h1Check(ContentEN.titleAndH1Expected)
        textOnPageCheck(ContentEN.captionExpected, captionSelector)
  ...
  "as an agent in english" when {
    ...
    ".show" should {
      ...
      "return single employment summary view when there is only one employment without Expenses and Benefits" which {
        ...
        textOnPageCheck(ContentEN.contentExpectedAgent, employmentSummaryParagraphSelector)
  ...
  "as an individual in welsh" when {
    ...
    ".show" should {
      ...
      "return single employment summary view when there is only one employment without Expenses and Benefits" which {
        ...
        textOnPageCheck(ContentCY.contentExpectedIndividual, employmentSummaryParagraphSelector)
      ...
      "render multiple employment summary view when there are two employments without Expenses and Benefits" which {
        ...
        titleCheck(ContentCY.titleAndH1Expected)
        h1Check(ContentCY.titleAndH1Expected)
        textOnPageCheck(ContentCY.captionExpected, captionSelector)
  ...
  "as an agent in welsh" when{
    ...
    ".show" should {
      ...
      "return single employment summary view when there is only one employment without Expenses and Benefits" which {
        ...
        textOnPageCheck(ContentCY.contentExpectedAgent, employmentSummaryParagraphSelector)
