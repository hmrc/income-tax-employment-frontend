...
class AmendEmploymentBenefitsUpdateAuditSpec extends UnitTestWithApp {
  ...
  "writes" when {
    "passed a AmendEmploymentBenefitsUpdate model" should {
      "produce valid json" in {
        ...
        val auditModel = AmendEmploymentBenefitsUpdateAudit(2020, "individual", "AA12343AA", "mtditid",
