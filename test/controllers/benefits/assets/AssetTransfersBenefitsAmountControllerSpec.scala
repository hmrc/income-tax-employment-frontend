...
class AssetTransfersBenefitsAmountControllerSpec extends ControllerUnitTest
  ...
  private val pageView = inject[AssetTransfersBenefitsAmountView]
  private val formsProvider = new AssetsFormsProvider()

  private lazy val underTest = new AssetTransfersBenefitsAmountController(
    mockActionsProvider,
    pageView,
    mockAssetsService,
    mockRedirectService,
  ...
  private val clazz = classOf[AssetTransfersBenefitsAmountController]
