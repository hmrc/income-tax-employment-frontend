...
class AssetTransfersBenefitsPageSpec extends UnitTest {
  ...
  ".apply(...)" should {
    "create page model with error form when form has errors" in {
      ...
      AssetTransfersBenefitsPage.apply(anyTaxYear, anyEmploymentId, aUser, formWithErrors, anEmploymentUserData) shouldBe AssetTransfersBenefitsPage(
        taxYear = anyTaxYear,
    ...
    "create page model with form populated from the assetsModel assetTransferQuestion" in {
      ...
      AssetTransfersBenefitsPage.apply(anyTaxYear, anyEmploymentId, aUser, questionForm, employmentUserData) shouldBe AssetTransfersBenefitsPage(
        taxYear = anyTaxYear,
        employmentId = anyEmploymentId,
        isAgent = aUser.isAgent,
