...
class ReimbursedServiceSpec extends UnitTest with MockEmploymentSessionService {
  ...
  "updateExpensesQuestion" should {
    "set expensesQuestion to true when true" in {
      ...
      await(underTest.updateExpensesQuestion(taxYear, employmentId, givenEmploymentUserData, questionValue = true)) shouldBe
        Right(expectedEmploymentUserData)
    }
    ...
    "set expensesQuestion to false and expenses value is cleared when false" in {
      ...
      await(underTest.updateExpensesQuestion(taxYear, employmentId, givenEmploymentUserData, questionValue = false)) shouldBe
        Right(expectedEmploymentUserData)
    }
  }
  ...
  "updateExpenses" should {
    "set expenses amount" in {
      ...
      await(underTest.updateExpenses(taxYear, employmentId, givenEmploymentUserData, amount = 123)) shouldBe Right(expectedEmploymentUserData)
    }
  }
  ...
  "updateTaxableExpensesQuestion" should {
    "set taxableExpensesQuestion to true when true" in {
      ...
      await(underTest.updateTaxableExpensesQuestion(taxYear, employmentId, givenEmploymentUserData, questionValue = true)) shouldBe
        Right(expectedEmploymentUserData)
    }
    ...
    "set taxableExpensesQuestion to false and taxableExpenses value is cleared when false" in {
      ...
      await(underTest.updateTaxableExpensesQuestion(taxYear, employmentId, givenEmploymentUserData, questionValue = false)) shouldBe
        Right(expectedEmploymentUserData)
    }
  }
  ...
  "updateTaxableExpenses" should {
    "set taxableExpenses amount" in {
      ...
      await(underTest.updateTaxableExpenses(taxYear, employmentId, givenEmploymentUserData, amount = 123)) shouldBe Right(expectedEmploymentUserData)
    }
  }
  ...
  "updateVouchersAndCreditCardsQuestion" should {
    "set vouchersAndCreditCardsQuestion to true when true" in {
      ...
      await(underTest.updateVouchersAndCreditCardsQuestion(taxYear, employmentId, givenEmploymentUserData, questionValue = true)) shouldBe
        Right(expectedEmploymentUserData)
    }
    ...
    "set vouchersAndCreditCardsQuestion to false and taxableExpenses value is cleared when false" in {
      ...
      await(underTest.updateVouchersAndCreditCardsQuestion(taxYear, employmentId, givenEmploymentUserData, questionValue = false)) shouldBe
        Right(expectedEmploymentUserData)
    }
  }
  ...
  "updateVouchersAndCreditCards" should {
    "set vouchersAndCreditCards amount" in {
      ...
      await(underTest.updateVouchersAndCreditCards(taxYear, employmentId, givenEmploymentUserData, amount = 123)) shouldBe Right(expectedEmploymentUserData)
    }
  }
  ...
  "updateNonCashQuestion" should {
    "set nonCashQuestion to true when true" in {
      ...
      await(underTest.updateNonCashQuestion(taxYear, employmentId, givenEmploymentUserData, questionValue = true)) shouldBe
        Right(expectedEmploymentUserData)
    }
    ...
    "set nonCashQuestion to false and nonCash value is cleared when false" in {
      ...
      await(underTest.updateNonCashQuestion(taxYear, employmentId, givenEmploymentUserData, questionValue = false)) shouldBe
        Right(expectedEmploymentUserData)
    }
  }
  ...
  "updateNonCash" should {
    "set nonCash amount" in {
      ...
      await(underTest.updateNonCash(taxYear, employmentId, givenEmploymentUserData, amount = 123)) shouldBe Right(expectedEmploymentUserData)
    }
  }
  ...
  "updateOtherItemsQuestion" should {
    "set otherItemsQuestion to true when true" in {
      ...
      await(underTest.updateOtherItemsQuestion(taxYear, employmentId, givenEmploymentUserData, questionValue = true)) shouldBe
        Right(expectedEmploymentUserData)
    }
    ...
    "set otherItemsQuestion to false and otherItems value is cleared when false" in {
      ...
      await(underTest.updateOtherItemsQuestion(taxYear, employmentId, givenEmploymentUserData, questionValue = false)) shouldBe
        Right(expectedEmploymentUserData)
    }
  }
  ...
  "updateOtherItems" should {
    "set otherItems amount" in {
      ...
      await(underTest.updateOtherItems(taxYear, employmentId, givenEmploymentUserData, amount = 123)) shouldBe Right(expectedEmploymentUserData)
    }
  }
}
