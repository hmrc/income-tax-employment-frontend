...
object CompanyCarBenefitsAmountPageBuilder {

  val aCompanyCarBenefitsAmountPage: CompanyCarBenefitsAmountPage = CompanyCarBenefitsAmountPage(
    taxYear = TaxYearUtils.taxYearEOY,
    employmentId = "employmentId",
    isAgent = false,
    form = new FuelFormsProvider().companyCarAmountForm(isAgent = false)
  )
}
