...
object CompanyCarBenefitsPageBuilder {

  val aCompanyCarBenefitsPage: CompanyCarBenefitsPage = CompanyCarBenefitsPage(
    taxYear = TaxYearUtils.taxYearEOY,
    employmentId = "employmentId",
    isAgent = false,
    form = new FuelFormsProvider().companyCarForm(isAgent = false)
  )
}
