...
object DidYouLeaveEmployerPageBuilder {

  val aDidYouLeaveEmployerPage: DidYouLeaveEmployerPage = DidYouLeaveEmployerPage(
    taxYear = taxYearEOY,
    employmentId = "employmentId",
    isAgent = false,
    titleFirstDate = LocalDate.of(taxYearEOY - 1, Month.APRIL, 6),
