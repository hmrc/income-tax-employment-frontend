...
object LivingAccommodationBenefitsPageBuilder {

  val aLivingAccommodationBenefitsPage: LivingAccommodationBenefitsPage = LivingAccommodationBenefitsPage(
    taxYear = TaxYearUtils.taxYearEOY,
    employmentId = "employmentId",
    isAgent = false,
    form = new AccommodationFormsProvider().livingAccommodationForm(isAgent = false)
  )
}
