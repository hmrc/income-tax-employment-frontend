...
object QualifyingRelocationBenefitsPageBuilder {

  val aQualifyingRelocationBenefitsPage: QualifyingRelocationBenefitsPage = QualifyingRelocationBenefitsPage(
    taxYear = TaxYearUtils.taxYearEOY,
    employmentId = "employmentId",
    isAgent = false,
    form = new AccommodationFormsProvider().qualifyingRelocationForm(isAgent = false)
  )
}
