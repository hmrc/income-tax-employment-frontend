...
object EmployerOffPayrollWorkingStatusPageBuilder {

  val aEmployerOffPayrollWorkingStatusPage: EmployerOffPayrollWorkingStatusPage = EmployerOffPayrollWorkingStatusPage(
    taxYear = taxYearEOY,
