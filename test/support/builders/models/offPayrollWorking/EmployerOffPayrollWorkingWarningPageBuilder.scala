...
package support.builders.models.offPayrollWorking
...
object EmployerOffPayrollWorkingWarningPageBuilder {

  val aEmployerOffPayrollWorkingWarningPage: EmployerOffPayrollWorkingWarningPage = EmployerOffPayrollWorkingWarningPage(
    taxYear = taxYearEOY,
