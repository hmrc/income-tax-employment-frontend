...
class TravelOrSubsistenceBenefitsAmountViewSpec extends ViewUnitTest {
  ...
  object ExpectedIndividualCY extends SpecificExpectedResults {
    ...
    val expectedContent: String = "Maeír wybodaeth hon ar gael yn adran N ar eich ffurflen P11D."
    ...
    val maxAmountErrorText: String = "Maeín rhaid iích buddiant teithio a chynhaliaeth fod yn llai na £100,000,000,000"
  }
  ...
  object ExpectedAgentCY extends SpecificExpectedResults {
    ...
    val expectedContent: String = "Maeír wybodaeth hon ar gael yn adran N ar ffurflen P11D eich cleient."
    val expectedErrorTitle: String = s"Gwall: $expectedTitle"
    ...
    val maxAmountErrorText: String = "Maeín rhaid i fuddiant teithio a chynhaliaeth eich cleient fod yn llai na £100,000,000,000"
  }
  ...
  userScenarios.foreach { userScenario =>
    ...
    s"language is ${welshTest(userScenario.isWelsh)} and request is from an ${agentTest(userScenario.isAgent)}" should {
      ...
      "render the travel or subsistence benefits amount page with pre-filled form" which {
        ...
        val htmlFormat = underTest(taxYearEOY, form(userScenario.isAgent).fill(100), Some(100), employmentId)
      ...
      "should render the travel or subsistence benefits amount page with wrong format text when input is in incorrect format" which {
        ...
        val htmlFormat = underTest(taxYearEOY, form(userScenario.isAgent).bind(Map(AmountForm.amount -> "abc")), Some(100), employmentId)
      ...
      "should render the travel or subsistence benefits amount page with max error when input > 100,000,000,000" which {
        ...
        val htmlFormat = underTest(taxYearEOY, form(userScenario.isAgent).bind(Map(AmountForm.amount -> "9999999999999999999999999999")), Some(100), employmentId)
