    ...
    s"language is ${welshTest(userScenario.isWelsh)} and request is from an ${agentTest(userScenario.isAgent)}" should {
      "return the multiple employment summary EOY page" when {
        "there are 2 employments and its EOY showing 2 employments with expenses" which {
          ...
          val htmlFormat = underTest(taxYearEOY, employments, expensesExist = true, isInYear = false, isAgent = userScenario.isAgent, Some(true))
        ...
        "there are 2 employments and its EOY showing 2 employments without expenses" which {
          ...
          implicit val messages: Messages = getMessages(userScenario.isWelsh)
          val employments = Seq(anEmploymentSource, anEmploymentSource.copy(employerName = "Ken Bosford", employmentId = "002"))
          val htmlFormat = underTest(taxYearEOY, employments, expensesExist = false, isInYear = false, isAgent = userScenario.isAgent, Some(true))
      ...
      "return the multiple employment summary in year page" when {
        "there are 2 employments and its in year showing 2 employments with expenses" which {
          ...
          implicit val messages: Messages = getMessages(userScenario.isWelsh)
          val employments = Seq(anEmploymentSource, anEmploymentSource.copy(employerName = "Ken Bosford", employmentId = "002"))
          val htmlFormat = underTest(taxYear, employments, expensesExist = true, isInYear = true, isAgent = userScenario.isAgent, Some(true))
        ...
        "there are 2 employments and its in year showing 2 employments without expenses" which {
          ...
          implicit val messages: Messages = getMessages(userScenario.isWelsh)
          val employments = Seq(anEmploymentSource, anEmploymentSource.copy(employerName = "Ken Bosford", employmentId = "002"))
          val htmlFormat = underTest(taxYear, employments, expensesExist = false, isInYear = true, isAgent = userScenario.isAgent, Some(true))
      ...
      "render template when in year without employment but has expenses" which {
        ...
        val htmlFormat = underTest(taxYear, Seq.empty, expensesExist = true, isInYear = true, isAgent = userScenario.isAgent, Some(true))
      ...
      "show the summary page when no data is in session and in year" which {
        ...
        val htmlFormat = underTest(taxYear, Seq.empty, expensesExist = false, isInYear = true, isAgent = userScenario.isAgent, Some(true))
