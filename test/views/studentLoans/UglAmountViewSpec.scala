...
class UglAmountViewSpec extends ViewUnitTest {
  ...
  object ExpectedResultsIndividualEN extends CommonExpectedResults {
    ...
    override val expectedParagraphCheckText: String = "Check your payslips or P60."
  ...
  object ExpectedResultsIndividualCY extends CommonExpectedResults {
    ...
    override val expectedParagraphCheckText: String = "Gwiriwch eich slipiau cyflog neu’ch P60."
    override val inputFieldName: String = "amount"
  ...
  object ExpectedResultsAgentEN extends CommonExpectedResults {
    ...
    override val expectedParagraphCheckText: String = "Check your client’s payslips or P60."
    override val inputFieldName: String = "amount"
  ...
  object ExpectedResultsAgentCY extends CommonExpectedResults {
    ...
    override val expectedParagraphCheckText: String = "Gwiriwch slipiau cyflog neu P60 eich cleient."
    override val inputFieldName: String = "amount"
